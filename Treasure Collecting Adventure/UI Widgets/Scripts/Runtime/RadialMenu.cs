...
namespace LupinrangerPatranger.UIWidgets
{
    public class RadialMenu : UIWidget
    {
        ...
        //protected virtual MenuCharacter AddMenuCharacter(Sprite icon)
        //{
        //    MenuCharacter character = characterCache.Find(x => !x.isActiveAndEnabled);
        //    if (character == null)
        //    {
        //        character = Instantiate(m_Character) as MenuCharacter;
        //        characterCache.Add(character);
        //    }
        //    if (character.targetGraphic != null && character.targetGraphic is Image)
        //    {
        //        (character.targetGraphic as Image).overrideSprite = icon;
        //    }
        //    character.onTrigger.RemoveAllListeners();
        //    character.gameObject.SetActive(true);
        //    character.transform.SetParent(m_RectTransform, false);
        //    return character;
        //}
    }
}