...
using LupinrangerPatranger.InventorySystem.Configuration;
...
namespace LupinrangerPatranger.InventorySystem
{
    public class InventoryManager : MonoBehaviour
    {
        ...
        public static InventoryManager current
        {
            get
            {
                Assert.IsNotNull(m_Current, "Requires an Inventory Manager.Create one from Tools > Treasure Collecting Adventure > Inventory System > Create Inventory Manager!");
                return m_Current;
            }
        }
