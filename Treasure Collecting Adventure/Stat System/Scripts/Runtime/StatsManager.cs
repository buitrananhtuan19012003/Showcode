...
using System.Linq;
using LupinrangerPatranger.StatSystem.Configuration;
...
namespace LupinrangerPatranger.StatSystem
{
    public class StatsManager : MonoBehaviour
    {
        ...
        public static StatsManager current
        {
            get
            {
                Assert.IsNotNull(m_Current, "Requires a Stats Manager.Create one from Tools > Treasure Collecting Adventure > Stat System > Create Stats Manager!");
                return m_Current;
            }
        }
