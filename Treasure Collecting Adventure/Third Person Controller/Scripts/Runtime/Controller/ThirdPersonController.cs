...
namespace LupinrangerPatranger
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [SerializeField]
        private float m_GroundDampening = 0.15f;
        [SerializeField]
        private float m_StepOffset = 0.3f;
        [SerializeField]
        private float m_SlopeLimit = 65f;
        ...
        {
            get { return this.m_Motions; }
            set { this.m_Motions = value; }
        }

        public string ForwardInput
        {
            get { return this.m_ForwardInput; }
            set { this.m_ForwardInput = value; }
        }

        public string HorizontalInput
        {
            get { return this.m_HorizontalInput; }
            set { this.m_HorizontalInput = value; }
        }

        public float SpeedMultiplier
        {
            get { return this.m_SpeedMultiplier; }
            set { this.m_SpeedMultiplier = value; }
        }

        public AimType AimType
        {
            get { return this.m_AimType; }
            set { this.m_AimType = value;}
        }

        public string AimInput
        {
            get { return this.m_AimInput; }
            set { this.m_AimInput = value; }
        }

        public float AimRotation
        {
            get { return this.m_AimRotation; }
            set { this.m_AimRotation = value; }
        }
        ...
        {
            get { return this.m_AirSpeed; }
            set { this.m_AirSpeed = value; }
        }

        public float AirDampening
        {
            get { return this.m_AirDampening; }
            set { this.m_AirDampening = value; }
        }

        public float GroundDampening
        {
            get { return this.m_GroundDampening; }
            set { this.m_GroundDampening = value; }
        }

        public float StepOffset
        {
            get { return this.m_StepOffset; }
            set { this.m_StepOffset = value; }
        }

        public float SlopeLimit
        {
            get { return this.m_SlopeLimit; }
            set { this.m_SlopeLimit = value; }
        }

        public LayerMask GroundLayer
        {
            get { return this.m_GroundLayer; }
            set { this.m_GroundLayer = value; }
        }

        public float SkinWidth
        {
            get { return this.m_SkinWidth; }
            set { this.m_SkinWidth = value; }
        }

        public PhysicMaterial IdleFriction
        {
            get { return this.m_IdleFriction; }
            set { this.m_IdleFriction = value; }
        }

        public PhysicMaterial MovementFriction
        {
            get { return this.m_MovementFriction; }
            set { this.m_MovementFriction = value; }
        }

        public PhysicMaterial StepFriction
        {
            get { return this.m_StepFriction; }
            set { this.m_StepFriction = value; }
        }

        public PhysicMaterial AirFriction
        {
            get { return this.m_AirFriction; }
            set { this.m_AirFriction = value; }
        }

        public AudioMixerGroup AudioMixerGroup
        {
            get { return this.m_AudioMixerGroup; }
            set { this.m_AudioMixerGroup = value; }
        }

        public List<AudioClip> FootstepClips
        {
            get { return this.m_FootstepClips; }
            set { this.m_FootstepClips = value; }
        }

        public float ForwardDampTime
        {
            get { return this.m_ForwardDampTime; }
            set { this.m_ForwardDampTime = value; }
        }

        public float HorizontalDampTime
        {
            get { return this.m_HorizontalDampTime; }
            set { this.m_HorizontalDampTime = value; }
        }
        ...
        {
            get { return this.m_Stepping; }
        }

        public Vector3 RawInput
        {
            get { return this.m_RawInput; }
            set { this.m_RawInput = value; }
        }
        ...
        {
            get { return this.m_LookRotation; }
        }

        public Vector3 RootMotionForce
        {
            get { return this.m_RootMotionForce; }
        }
