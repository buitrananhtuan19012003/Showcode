...
{
    [System.Serializable]
    public class Player : ScriptableObject, INameable, IJsonSerializable
    {
        [SerializeField]
        [HideInInspector]
        private string m_Id;
        ...
        [Tooltip("Unique name of the character. It can be used to display the character name in UI.")]
        [SerializeField]
        private string m_CharacterName = "New Character";
        ...
        [SerializeField]
        private bool m_UseCharacterNameAsDisplayName = true;
        [Tooltip("Characters name to display in UI.")]
        [SerializeField]
        private string m_DisplayName = "New Character";

        public string DisplayName
        {
            get
            {
                string displayName = m_UseCharacterNameAsDisplayName ? this.m_CharacterName : this.m_DisplayName;
        ...
        private static Rarity DefaultRarity
        {
            get
            {
                if (Player.m_DefaultRarity is null)
                {
                    //TODO make not deletable in editor
                    Player.m_DefaultRarity = ScriptableObject.CreateInstance<Rarity>();
                    Player.m_DefaultRarity.Name = "None";
                    Player.m_DefaultRarity.Color = Color.grey;
                    Player.m_DefaultRarity.Chance = 100;
                    Player.m_DefaultRarity.Multiplier = 1.0f;
                }
                return Player.m_DefaultRarity;
            }
        }
        ...
        [Tooltip("Is this character sellable to a vendor? More options will appear if it is sellable.")]
        [SerializeField]
        ...
        [Tooltip("Characters buy price. This value will be multiplied with the rarities price multiplier.")]
        [SerializeField]
        ...
        [Tooltip("If set to true, this character will be added to the vendors inventory and the player can buy it back.")]
        [SerializeField]
        ...
        [Tooltip("Characters sell price. This value will be multiplied with the rarities price multiplier.")]
        [SerializeField]
        ...
        [Tooltip("Characters stack definition. New created characters will have this stack. Use a stack modifier to randomize the stack.")]
        [SerializeField]
        [Range(1, 100)]
        ...
        public virtual int Stack
        {
            ...
            set
            {
                ...
                if (Slot != null)
                {
                    ...
                    {
                        CharacterContainer.RemoveCharacterCompletely(this);
                    }
                    Slot.Repaint();
        ...
        [Tooltip("Can this character be destroyed?")]
        [SerializeField]
        ...
        [Tooltip("If set to true, the character is droppable from a container to the scene.")]
        [SerializeField]
        ...
        [Tooltip("Sound that should be played when the character is dropped to the scene.")]
        [SerializeField]
        ...
        [Tooltip("By default characters prefab will be instantiated when dropped to the scene, you can override this option.")]
        [SerializeField]
        ...
        public virtual void GetObjectData(Dictionary<string, object> data)
        {
            ...
            data.Add("RarityIndex", CharacterManager.Database.raritys.IndexOf(Rarity));
        ...
        public virtual void SetObjectData(Dictionary<string, object> data)
        {
            ...
            if (data.ContainsKey("RarityIndex"))
            {
                ...
                if (rarityIndex > -1 && rarityIndex < CharacterManager.Database.raritys.Count)
                {
                    this.m_Rarity = CharacterManager.Database.raritys[rarityIndex];
                }
            }
            ...
            if (data.ContainsKey("Reference"))
            {
                ...
                for (int i = 0; i < references.Count; i++)
                {
                    ...
                    CharacterContainer referenceContainer = WidgetUtility.Find<CharacterContainer>(container);
                    if (referenceContainer != null)
                    {
                        referenceContainer.ReplaceCharacter(slot, this);
                    }
                }
            }
        }
