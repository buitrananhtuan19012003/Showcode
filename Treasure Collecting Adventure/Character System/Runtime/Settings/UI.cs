...
namespace LupinrangerPatranger.CharacterSystem.Configuration
{
    ...
    public class UI : Settings
    {
        ...
        private CharacterContainer m_SellPriceTooltip;
        public CharacterContainer sellPriceTooltip
        {
            get
            {
                if (this.m_SellPriceTooltip == null)
                {
                    this.m_SellPriceTooltip = WidgetUtility.Find<CharacterContainer>(this.sellPriceTooltipName);
                }
