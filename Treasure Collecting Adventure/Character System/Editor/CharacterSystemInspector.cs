...
namespace LupinrangerPatranger.CharacterSystem
{
    ...
    public class CharacterSystemInspector
    {
        ...
        public void OnEnable()
        {
            ...
            {
                string[] guids = AssetDatabase.FindAssets("t:" + typeof(CharacterDatabase).FullName);
                if (guids.Length > 0)
                {
            ...
            toolbarIndex = EditorPrefs.GetInt("CharacterToolbarIndex");
        ...
        public void OnDisable()
        {
            ...
            EditorPrefs.SetInt("CharacterToolbarIndex", toolbarIndex);
        ...
        private static void CreateDefaultCategory(CharacterDatabase database)
        {
