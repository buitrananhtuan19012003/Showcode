...
{
    [CustomEditor(typeof(CharacterContainer), true)]
    public class ItemContainerInspector : UIWidgetInspector
    {
        ...
        private void DrawInspector()
        {
            ...
            CharacterCollection collection = (target as CharacterContainer).GetComponent<CharacterCollection>();
            ...
            DrawTypePropertiesExcluding(typeof(CharacterContainer), this.m_PropertiesToExcludeForDefaultInspector);
