...
{
    public class CharacterReferenceEditor : EditorWindow
    {
        public static void ShowWindow()
        {
            CharacterReferenceEditor window = EditorWindow.GetWindow<CharacterReferenceEditor>(true, "Character Reference Updater");
        ...
        private void UpdateComponent(Component component)
        {
            ...
            players.AddRange(this.m_Database.players);
            players.AddRange(this.m_Database.categories);
            players.AddRange(this.m_Database.raritys);
            //players.AddRange(this.m_Database.equipments);
            players.AddRange(this.m_Database.currencies);
            //players.AddRange(this.m_Database.itemGroups);
            //Debug.Log("Component Update: "+component.gameObject+" "+component.GetType());
            UpdateReference(component, players);
        }
