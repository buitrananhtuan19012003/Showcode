...
namespace LupinrangerPatranger
{
    ...
    public abstract class CollectionEditor<T> : ICollectionEditor
    {
        ...
        protected int m_SelectedCharacterIndex;
        protected T selectedCharacter
        {
            get
            {
                //if (m_SelectedCharacterIndex > -1 && m_SelectedCharacterIndex < Players.Count)
                //{
                //    return Players[m_SelectedCharacterIndex];
                //}
                return default;
            }
        }
        ...
        //protected abstract List<T> Players { get; }
        ...
        //virtual void Select2(T player)
        //{
        //    int index2 = Players.IndexOf(player);
        //    if (this.m_SelectedCharacterIndex != index2)
        //    {
        //        this.m_SelectedCharacterIndex = index2;
        //        this.m_ScrollPosition.y = 0f;
        //    }
        //}
